...
public class PerfilFragment extends Fragment {
    ...
    private TextView namePerfil, emailPerfil;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       /* namePerfil = (TextView)v.findViewById(R.id.nameDrawer);
        emailPerfil = (TextView)v.findViewById(R.id.textViewDrawer);
        ...
        ref.child(actualUser).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                namePerfil.setText(usuarios.getNombre());
