...
public class MenuPrincipal extends AppCompatActivity
    ...
    DatePicker dayStartChoose;
    Button saveBtn;
    CheckBox statusChbox;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                d.setContentView(R.layout.fragment_add);
                ...
                //statusChbox = (CheckBox)d.findViewById(R.id.checkBoxStatus);
                ...
                saveBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        s.setStatus(statusChbox.isChecked());

                        String name = nameEditText.getText().toString();
                        String desc = descEditText.getText().toString();
                        String start = startEditText.getText().toString();
                        String finish = finishEditText.getText().toString();
                        boolean status = statusChbox.isChecked();

                        Activity activity = new Activity(name,desc,start,finish,status);
        ...
        ref.child(actualUser).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                Userss usuarios = dataSnapshot.getValue(Userss.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            PerfilFragment f = PerfilFragment.newInstance("","");
            FragmentManager m = getFragmentManager();
            FragmentTransaction t = m.beginTransaction();
            t.replace(R.id.content_principal,f,"Perfil");
            t.commit();
            /*PerfilFragment pf = PerfilFragment.newInstance("we are", "not using these");
            swapFragment(pf);*/
            ...
            FragmentManager m = getFragmentManager();
            FragmentTransaction t = m.beginTransaction();
            t.replace(R.id.content_principal,pbf,"Progress bar");
            t.commit();
           /*ProgressBarFragment pbf = ProgressBarFragment.newInstance("we are", "not using these");
            swapFragment(pbf);*/
